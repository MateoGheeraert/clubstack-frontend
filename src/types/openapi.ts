...
export interface paths {
    ...
    "/activities/{id}/attendees": {
        ...
        put?: never;
        /**
         * Add non-user attendee to activity (Admin/Moderator only)
    ...
    "/activities/{id}/attendees/{attendee}": {
        ...
        post?: never;
        /**
         * Remove non-user attendee from activity (Admin/Moderator only)
    ...
    "/organizations/{id}/users/email": {
        ...
        get?: never;
        put?: never;
        /** Add user to organization by email (Admin only) */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/organizations/{id}/users/{userId}": {
         ...
         * @description Promote or demote a user by changing their role. Possible roles: USER, MODERATOR, ADMIN
         */
        patch: {
            parameters: {
                query?: never;
